...
with(filtered, lines(y = Sub_metering_2, x= DateTime, ylab = "Global active power (kilowatts)", xlab= NA, col="red"))
with(filtered, lines(y = Sub_metering_3, x= DateTime, ylab = "Global active power (kilowatts)", xlab= NA, col="blue"))
dev.off()
